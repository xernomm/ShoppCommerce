...
const MapModal = ({onSelectLocation, show, handleClose, setAddressInfo }) => {
    ...
    try {
      ...
      if (response.data && response.data.address) {
        ...
        setAddressInfo({
          ...
          subdistrict: address.city_district || address.subdistrict || "",
          city: address.city || "",
          state: address.state || "",
        ...
        onSelectLocation(lat, lng, address); // Pass the address object to the onSelectLocation function
        handleClose();
      } else {
        console.error("No address data found in the response.");
      }
    } catch (error) {
  ...
  return (
    ...
    >
      <div className="modal-dialog modal-dialog-centered modal-lg" role="document" style={{ maxWidth: "80%", maxHeight: "50%" }}>
